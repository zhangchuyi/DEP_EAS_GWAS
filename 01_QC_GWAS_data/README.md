...
3. Imputation (not retained as code): prephasing with **SHAPEIT5**, imputation
   with **Minimac4** using the **PGGHan2** (N=20,823) Han Chinese reference
   panel. Post-imputation filters: R² > 0.8, MAF > 1 %, call rate > 95 %,
